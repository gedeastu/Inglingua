...
export default function TypeClass(){
    ...
    return(
        ...
        {showElement === 'showOnline' && (
           <button id="started" onClick={()=> navigation('/TeacherSection')} className='w-[28rem] transition-all ease-in-out mt-64 duration-300 h-max bg-gradient-to-r from-[#172A87] to-[#E05E0A] p-0.5 rounded-2xl overflow-hidden relative'>
