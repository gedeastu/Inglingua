...
export default function Duration(){
    ...
    return(
        ...
        <input id='jam' type="number" min={1} max={2} placeholder='0' className='bg-transparent p-0 w-2.5 text-white overflow-hidden border-none text-center m-0 focus:ring-0 focus:outline-none'/>
