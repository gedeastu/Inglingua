...
const Content = () => {
  ...
  return (
    ...
    <main className='flex flex-col items-center gap-5 pt-[7rem] h-96'>
      <button onClick={()=>navigate('/Login')} id="login" className='w-96 bg-gradient-to-r  from-[#172A87] to-[#E05E0A] p-0.5 rounded-full overflow-hidden relative'>
      ...
      <button onClick={()=>navigate('/SignUp')} id="login" className='w-96 bg-gradient-to-r from-[#172A87] to-[#E05E0A] p-0.5 rounded-full overflow-hidden relative'>
      ...
      <h2 className='text-white/60'>Back to Home</h2>
      </button>
    </main>
    </>
  );
