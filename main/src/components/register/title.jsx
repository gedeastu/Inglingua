...
const Title = () => {
  return (
    <>
    <header className='bg-[#172A87] flex justify-center relative items-center h-64 rounded-br-full rounded-bl-full'>
      ...
      <h1 className='font-black text-4xl text-white uppercase font-TGL'>Inglingua</h1>
    </header>
    </>
  );
};
