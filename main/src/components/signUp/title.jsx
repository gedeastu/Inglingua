...
const Title = () => {
  return (
    ...
    <header className='bg-[#172A87] flex flex-col items-center relative h-60 rounded-br-full rounded-bl-full'>
      ...
      <h1 className='font-black text-4xl text-white uppercase font-TGL mt-10'>I n g l i n g u a</h1>
      <img src={ilustrations} alt="" className='w-[26rem] absolute -bottom-[15rem]'/>
    </header>
    </>
  );
};
